# Fast-track your way to becoming a 'mortgage slave'un
```
这是一个完全由AI完成的用于帮助你快速成为房奴的贝壳网数据爬虫，可以爬取贝壳网的成交数据和在售数据，包括标题、价格、日期、装修情况、户型、面积等详细信息。
export https_proxy=http://127.0.0.1:7890 http_proxy=http://127.0.0.1:7890 all_proxy=socks5://127.0.0.1:7890
## 项目总结 成交数据JSON格式
- `chengjiao_data.csv` - 成交数据CSV格式
### 🎯 项目目标
本项目旨在通过爬取贝壳网的房产数据，帮助用户了解房地产市场动态，分析房价趋势，为购房决策提供数据支持。houfang_data.json` - 在售数据JSON格式
